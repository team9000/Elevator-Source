...
if SERVER then
	...
	-- Using our own site for the elevator source YouTube videos
	----- PixelTail have not released their sourcecode for their old YouTube video browser, which is using the outdated version of the YouTube Feed API
	ENT.URL	= "https://reperio-studios.net/elevatorsource/"
	ENT.URL_YT	= "https://www.youtube.com/embed/"
	...
	function ENT:UpdateTV( vid, time )
		...
		if ( vid ) then
			msg("hue")
			self.Browser:OpenURL( self.URL_YT .. vid )
		else
